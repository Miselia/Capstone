...
public class Game : MonoBehaviour, IGenericEventListener
{
    ...
    void Start()
    {
        ...
        PlayerEntity.Create(entityManager, new Vector2(-boundaryOffset,0), new Vector2(0, 0), playerRadius, 1, maxHealth, mesh2D, playerMat);
        PlayerEntity.Create(entityManager, new Vector2(boundaryOffset, 0), new Vector2(0, 0), playerRadius, 2, maxHealth, mesh2D, playerMat);
