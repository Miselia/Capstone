...
public class Game : MonoBehaviour, IGenericEventListener
{
    ...
    private int boundaryOffest = Constants.PlayerBoundaryOffset;
    ...
    void Start()
    {
        ...
        PlayerEntity.Create(entityManager, new Vector2(-boundaryOffest,0), new Vector2(0, 0), playerRadius, 1, maxHealth, mesh2D, playerMat);
        PlayerEntity.Create(entityManager, new Vector2(boundaryOffest, 0), new Vector2(0, 0), playerRadius, 2, maxHealth, mesh2D, playerMat);
